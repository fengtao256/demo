...
//        Document document = new Document("D:\\complay-file\\公司项目\\气象灾害知识库项目\\系统开发\\雄安新区\\农业气象服务专报（第1期）.doc");
//
//        //使用新文本替换文档中的指定文本
//        String  string = document.getText().replaceAll("\\x0d\\x0a\\x0d\\x0a\\x0d\\x0a","") ;
